...
# Step 1: Load HVI rankings and filter to NYC ZCTAs
...
# Step 2: Load ZCTA shapefile and filter to NYC
...
# Step 3: Join HVI to geometry and export
...
# Step 4: Load and clean outdoor heat forecast
df_heat = pd.read_csv(
